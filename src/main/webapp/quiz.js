document.addEventListener('DOMContentLoaded', () =>{
    ...
    console.log("retrieved from local storage", {selectedSubjectId, selectedSubjectName});

    if(!selectedSubjectId){
        console.error("no subject id found: redirection ...");
...
//===============================================================
    ...
    async function loadQuestionsFromServer() {
        console.log("js is sending this id: "+selectedSubjectId);
        try {

            const response = await fetch(`api/questions?subjectId=${selectedSubjectId}`, {
                method: 'GET',
                headers: {
            ...
            console.log('Fetching from:', `api/questions?subjectId=${selectedSubjectId}`);
            ...
            if (!Array.isArray(data)) {
                console.error("Server returned an error instead of questions:", data);
                questionElement.innerText = "Error: " + (data.error || "Unknown server error");
                return;
            }
